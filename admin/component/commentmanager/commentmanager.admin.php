...
if($_POST['comment_params_num'] != '') {
	...
	$com_query 			= 'UPDATE '.PREFIX.'component SET `params`="'.$comment_params_width.','.$comment_params_num.'" WHERE  `id`="'.$com_params['id'].'" ';
	...
	echo '<tr>
			<td>Width </td><td><input type=text name="comment_params_width" value="'. $config [0].'" size=5>columm</td>
		  </tr>';
	echo '<tr>
			<td>Number comments per page </td><td><input type=text name="comment_params_num" value="'. $config [1].'"  size=5></td>
		  </tr>';
