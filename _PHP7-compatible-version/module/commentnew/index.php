...
<?php
if ( $config [3] == "on") {
	echo "<span href='".$_URL->getOldUrl ()."#Showcomment2' onClick='Showcomment2();' name='Showcomment2' style='color:blue;text-decoration:underline;cursor: hand; cursor: pointer; '>Hiện thị comment bài viết mới nhất</span>";
