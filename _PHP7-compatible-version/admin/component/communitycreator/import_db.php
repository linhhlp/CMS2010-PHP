...
mysqli_query($setting_charset);
echo mysqli_error();
mysqli_query($category_insert);
mysqli_query($frontpage_insert);
mysqli_query($component_insert);
mysqli_query($menu_insert);
mysqli_query($module_insert);
mysqli_query($position_insert);
mysqli_query($plugin_insert);
mysqli_query($community_insert);
}
?>